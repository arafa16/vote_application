...
const { saveEmailData } = require("../controllers/mailing.controller.js");
    ...
    await saveEmailData(
      {
        ...
        subject: "Reset Password Aplikasi Kopkarla - Aplikasi Kopkarla",
        body: resetPasswordEmailTemplate(result?.name, link_reset),
        type: "password_reset",
      },
      transaction,
    );

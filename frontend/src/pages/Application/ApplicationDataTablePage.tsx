...
const ApplicationDataTablePage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setDataTable(dataApplication?.data);
      setMetaTableData(dataApplication?.meta);
  ...
  useEffect(() => {
    if (search !== "") {
      const handler = setTimeout(() => {
        ...
        dispatch(GetApplicationTable(searchParams));
      }, 500);
    ...
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 mb-2">
          <div
            className={`col-span-2 md:col-span-1 h-1 ${!isLoadingApplication ? "hidden" : ""}`}
          >
            <LoadingIcon
              icon="three-dots"
              color="#005266"
...
export default ApplicationDataTablePage;

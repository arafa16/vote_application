...
const ApplicationDataViewByIdPage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setDataView(dataApplication?.data);
  ...
  const handleEdit = () => {
    navigate(`/application/data/${id}/edit`);
  };

  const handleDelete = () => {
    dispatch(DeleteApplicationData({ uuid: id }));
  };
      ...
      <div className="mt-2">
        ...
        <div className="box mt-1">
          <div className="grid grid-cols-12 px-8 py-4 gap-4">
            ...
            <div className="col-span-12 md:col-span-6 grid grid-cols-12">
              <p className="col-span-6 md:col-span-3">Logo</p>
              <p className="col-span-6 md:col-span-8">: {dataView?.logo}</p>
            </div>
          </div>
        </div>
      </div>
...
export default ApplicationDataViewByIdPage;

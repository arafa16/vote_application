...
const CommissionerCandidateDataTablePage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setDataTable(dataCommissionerCandidate?.data);
      setMetaTableData(dataCommissionerCandidate?.meta);
  ...
  useEffect(() => {
    if (search !== "") {
      const handler = setTimeout(() => {
        ...
        dispatch(GetCommissionerCandidateTable(searchParams));
      }, 500);
  ...
  const handleCreate = () => {
    navigate("/commissioner_candidate_setup/create");
  };
    ...
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 mb-2">
          <div
            className={`col-span-2 md:col-span-1 h-1 ${!isLoadingCommissionerCandidate ? "hidden" : ""}`}
          >
            <LoadingIcon
              icon="three-dots"
              color="#005266"
...
export default CommissionerCandidateDataTablePage;

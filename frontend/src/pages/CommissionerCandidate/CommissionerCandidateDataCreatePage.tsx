...
import {
  GetCreateAttribute,
  CreateCommissionerCandidateData,
...
const CommissionerCandidateDataCreatePage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setAttributes(dataCommissionerCandidate?.data);
    ...
    if (
      ...
      navigate(
        `/commissioner_candidate_setup/data/${messagePatchCommissionerCandidate?.data?.uuid}`,
      );
      dispatch(resetCommissionerCandidate());
    } else if (
      messagePatchCommissionerCandidate !== "" &&
  ...
  const handleSubmit = () => {
    ...
    dispatch(CreateCommissionerCandidateData({ formData: formDataSubmit }));
  };
...
export default CommissionerCandidateDataCreatePage;

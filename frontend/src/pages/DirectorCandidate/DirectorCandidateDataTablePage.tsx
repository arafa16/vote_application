...
const DirectorCandidateDataTablePage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setDataTable(dataDirectorCandidate?.data);
      setMetaTableData(dataDirectorCandidate?.meta);
  ...
  useEffect(() => {
    if (search !== "") {
      const handler = setTimeout(() => {
        ...
        dispatch(GetDirectorCandidateTable(searchParams));
      }, 500);
  ...
  const handleCreate = () => {
    navigate("/director_candidate_setup/create");
  };
    ...
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 mb-2">
          <div
            className={`col-span-2 md:col-span-1 h-1 ${!isLoadingDirectorCandidate ? "hidden" : ""}`}
          >
            <LoadingIcon
              icon="three-dots"
              color="#005266"
...
export default DirectorCandidateDataTablePage;

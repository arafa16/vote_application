...
const DirectorCandidateDataEditPage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setFormData({
        ...formData,
        voting_period_uuid: dataDirectorCandidate?.data?.voting_period?.uuid,
        name: dataDirectorCandidate?.data?.name,
        vision: dataDirectorCandidate?.data?.vision,
        mission: dataDirectorCandidate?.data?.mission,
      });
      setAttributes(dataDirectorCandidate?.attributes);
    ...
    if (
      ...
      navigate(`/director_candidate_setup/data/${id}`);
      dispatch(resetDirectorCandidate());
    } else if (
      messagePatchDirectorCandidate !== "" &&
      isErrorDirectorCandidate &&
  ...
  const handleSubmit = () => {
    ...
    dispatch(
      UpdateDirectorCandidateData({ uuid: id, formData: formDataSubmit }),
    );
  };
...
export default DirectorCandidateDataEditPage;

...
const SliderDataTablePage = () => {
  ...
  useEffect(() => {
    if (dataSlider !== null && isSuccessSlider && !isLoadingSlider) {
      setDataTable(dataSlider?.data);
      setMetaTableData(dataSlider?.meta);
  ...
  useEffect(() => {
    if (search !== "") {
      const handler = setTimeout(() => {
        ...
        dispatch(GetSliderTable(searchParams));
      }, 500);
    ...
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 mb-2">
          <div
            className={`col-span-2 md:col-span-1 h-1 ${!isLoadingSlider ? "hidden" : ""}`}
          >
            <LoadingIcon
              icon="three-dots"
              color="#005266"
            ...
            <Table>
              <Table.Thead>
                <Table.Tr>
                  ...
                  <Table.Th className="whitespace-nowrap">Page View</Table.Th>
                  <Table.Th className="whitespace-nowrap">Sequence</Table.Th>
                  <Table.Th className="whitespace-nowrap">Image Name</Table.Th>
                </Table.Tr>
              </Table.Thead>
              <Table.Tbody>
...
export default SliderDataTablePage;

    ...
    <div>
      ...
      >
        <div className="col-span-12">
          ...
          >
            <Lucide icon="CheckCircle" className="w-12 h-12" />
            <div>
              <p className="text-[14px] font-bold mb-1">Terima Kasih,</p>
              <p className="text-[14px] font-bold mb-1">
                Anda Telah Menggunakan Hak Pilih Pengurus dan Pengawas.
              </p>
              <p className="text-black">
                Partisipasi Anda sangat berarti untuk kemajuan Kopkarla.
              </p>
            </div>
          </Alert>
        </div>
          ...
          <Alert variant="soft-warning" className="flex items-center mb-2">
            ...
            <div>
              <p className="text-[14px] text-orange-800 mb-1">
                Data pilihan anda telah tercatat dengan aman.
              </p>
            </div>
          </Alert>
        </div>
...
export default HistoryVoteViewPage;

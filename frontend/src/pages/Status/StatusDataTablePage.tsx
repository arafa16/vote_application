...
const StatusDataTablePage = () => {
  ...
  useEffect(() => {
    if (dataStatus !== null && isSuccessStatus && !isLoadingStatus) {
      setDataTable(dataStatus?.data);
      setMetaTableData(dataStatus?.meta);
    ...
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 mb-2">
          <div
            className={`col-span-2 md:col-span-1 h-1 ${!isLoadingStatus ? "hidden" : ""}`}
          >
            <LoadingIcon
              icon="three-dots"
              color="#005266"
...
export default StatusDataTablePage;

...
const VotingPeriodDataTablePage = () => {
  ...
  useEffect(() => {
    if (
      ...
      setDataTable(dataVotingPeriod?.data);
      setMetaTableData(dataVotingPeriod?.meta);
  ...
  useEffect(() => {
    if (search !== "") {
      const handler = setTimeout(() => {
        ...
        dispatch(GetVotingPeriodTable(searchParams));
      }, 500);
    ...
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-12 mb-2">
          <div
            className={`col-span-2 md:col-span-1 h-1 ${!isLoadingVotingPeriod ? "hidden" : ""}`}
          >
            <LoadingIcon
              icon="three-dots"
              color="#005266"
...
export default VotingPeriodDataTablePage;
